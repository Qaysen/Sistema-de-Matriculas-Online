...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matricula.tipo'
        db.alter_column('principal_matricula', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Matricula.tipo'
        db.alter_column('principal_matricula', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=50))
